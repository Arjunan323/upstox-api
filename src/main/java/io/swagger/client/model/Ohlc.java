...
public class Ohlc {
  ...
  **/
   ...
   * @return high
  **/
  @Schema(example = "121", description = "The high price of the trading session")
   ...
   * @return low
  **/
  @Schema(example = "119", description = "The low price of the trading session")
   ...
   * @return close
  **/
  @Schema(example = "120", description = "The close price of the symbol from the previous session of trading")
