...
public class PositionData {
  ...
  **/
   ...
   * @return closePrice
  **/
  @Schema(example = "102", description = "Closing price of the instrument from the last trading day")
   ...
   * @return buyPrice
  **/
  @Schema(example = "102", description = "Average price at which quantities were bought")
   ...
   * @return sellPrice
  **/
  @Schema(example = "102", description = "Average price at which quantities were sold")
